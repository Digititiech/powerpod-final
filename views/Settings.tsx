...
const Settings: React.FC = () => {
  ...
  const handleDisconnectWhatsApp = async () => {
    ...
    try {
      const res = await fetch(`${API_BASE_URL}/disconnect-whatsapp`, { 
          method: 'POST',
          headers: { 'x-api-key': API_KEY }
      });
            ...
            <div className="bg-white p-10 rounded-[40px] border border-gray-100 shadow-sm space-y-10">
              ...
              <div className="flex flex-col items-center justify-center space-y-6">
                 {serverError ? (
                     ...
                     <div className="flex flex-col items-center text-center p-8 bg-blue-50 rounded-3xl w-full border border-blue-100">
                         <div className="w-16 h-16 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center mb-4">
                             <RefreshCw size={32} className="animate-spin" />
                         </div>
                         <h3 className="text-lg font-black text-blue-800">Connecting...</h3>
                         <p className="text-blue-600 font-medium text-sm mt-2">Establishing secure connection to WhatsApp...</p>
                     </div>
                 ) : waStatus === 'connected' ? (
                     <div className="flex flex-col items-center text-center p-8 bg-green-50 rounded-3xl w-full">
                         ...
                         {connectedNumber && (
                             <p className="text-green-700 font-bold text-lg mt-1 font-mono">{connectedNumber}</p>
                         )}
          ...
          <div className="bg-gray-900 p-8 rounded-[40px] shadow-2xl border border-white/5">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center p-4 bg-white/5 rounded-2xl">
                ...
                <span className={`text-[9px] font-black uppercase flex items-center ${waStatus === 'connected' ? 'text-green-500' : 'text-red-500'}`}>
